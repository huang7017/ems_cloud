...
const TemperaturePage = React.lazy(() => import('../features/Settings/Temperature/index'));
const VRFPage = React.lazy(() => import('../features/Settings/VRF/index'));
const MetersPage = React.lazy(() => import('../features/Settings/Meters/index'));
        ...
        <Container>
          <Box sx={{ minHeight: "calc(100vh - 170px)" }}>
            <Routes>
              ...
              <Route path="/settings/temperature" element={<TemperaturePage lng={"en"} />} />
              <Route path="/settings/vrf" element={<VRFPage lng={"en"} />} />
              <Route path="/settings/meters" element={<MetersPage lng={"en"} />} />
            </Routes>
          </Box>
        </Container>
      </Page>
